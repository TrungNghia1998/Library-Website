    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result.data, function (key, item) {
                ...
                html += '<td><a class="btn btn-default btn-sm" href="/Admin/Book/Edit/' + item.BookID + '"><i class="fa fa-edit"></i> Sửa</a>  <a class="btn btn-danger btn-sm" onclick="DeleteBook(' + item.BookID + ')"><i class="fa fa-trash"></i> Xoá</a></td>';
                html += '</tr>';
            });
            $('.tbody').html(html);
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result.data, function (key, item) {
                ...
                html += '<td><a class="btn btn-default btn-sm" href="/Admin/ChapterDetail/Edit?idbook=' + result.idbook + '&idchapter=' + item.ID + '"><i class="fa fa-edit"></i> Sửa</a>  <a class="btn btn-danger btn-sm" onclick="DeleteChapter(' + result.idbook + ',' + item.ID + ')"><i class="fa fa-trash"></i> Xoá</a></td>';
                html += '</tr>';
            });
            ...
            if (result.pageNumber == 1) {
                ...
                if (page == 1) {
                    ...
                    paging += '<li class="paginate_button previous btn"><a  onclick="return loadListChapterByID(' + result.idbook + ',' + (page - 1) + ')" aria-controls="example1" data-dt-idx="0" tabindex="0">Previous</a></li>';
                    paging += '<li class="paginate_button btn"><a onclick="return loadListChapterByID(' + result.idbook + ',' + (page - 1) + ')" aria-controls="example1" data-dt-idx="0" tabindex="0">' + (page - 1) + '</a></li>';
                ...
                if (page + 1 <= result.pageNumber) {
                    paging += '<li class="paginate_button btn"><a  onclick="return loadListChapterByID(' + result.idbook + ',' + (page + 1) + ')" aria-controls="example1" data-dt-idx="0" tabindex="0">' + (page + 1) + '</a></li>';
                    paging += '<li class="paginate_button next btn" id="example1_next"><a onclick="return loadListChapterByID(' + result.idbook + ',' + (page + 1) + ')" aria-controls="example1" data-dt-idx="7" tabindex="0">Next</a></li>';
                } else {
                    paging += '<li class="paginate_button next disabled" id="example1_next"><a href="#" aria-controls="example1" data-dt-idx="7" tabindex="0">Next</a></li>';
                }
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result.data, function (key, item) {
                ...
                html += '<td><a class="btn btn-default btn-sm" onclick="getEbookByID(' + result.idbook + ',' + item.TypeEbookID + ')"><i class="fa fa-edit"></i> Sửa</a>  <a class="btn btn-danger btn-sm" onclick="DeleteEbook(' + result.idbook + ',' + item.TypeEbookID + ')"><i class="fa fa-trash"></i> Xoá</a></td>';
                html += '</tr>';
            });
            ...
            if (result.pageNumber == 1) {
                ...
                if (page == 1) {
                    ...
                    paging += '<li class="paginate_button previous btn"><a  onclick="return loadListEbookByBook(' + result.idbook + ',' + (page - 1) + ')" aria-controls="example1" data-dt-idx="0" tabindex="0">Previous</a></li>';
                    paging += '<li class="paginate_button btn"><a onclick="return loadListEbookByBook(' + result.idbook + ',' + (page - 1) + ')" aria-controls="example1" data-dt-idx="0" tabindex="0">' + (id - 1) + '</a></li>';
                    paging += '<li class="paginate_button active"><a onclick="" aria-controls="example1" data-dt-idx="0" tabindex="0">' + page + '</a></li>';
                }
                if (page + 1 <= result.pageNumber) {
                    paging += '<li class="paginate_button btn"><a  onclick="return loadListEbookByBook(' + result.idbook + ',' + (page + 1) + ')" aria-controls="example1" data-dt-idx="0" tabindex="0">' + (id + 1) + '</a></li>';
                    paging += '<li class="paginate_button next btn" id="example1_next"><a onclick="return loadListEbookByBook(' + result.idbook + ',' + (page + 1) + ')" aria-controls="example1" data-dt-idx="7" tabindex="0">Next</a></li>';
                } else {
                    paging += '<li class="paginate_button next disabled" id="example1_next"><a href="#" aria-controls="example1" data-dt-idx="7" tabindex="0">Next</a></li>';
                }
