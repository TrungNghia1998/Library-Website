    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result.data, function (key, item) {
                ...
                html += '<td><a class="btn btn-default btn-sm" onclick="return getbyID(' + item.UserID + ')"><i class="fa fa-edit"></i> Sửa</a>  <a class="btn btn-danger btn-sm" onclick="Delele(' + item.UserID + ')"><i class="fa fa-trash"></i> Xoá</a></td>';
                html += '</tr>';
            });
            $('.tbody').html(html);
