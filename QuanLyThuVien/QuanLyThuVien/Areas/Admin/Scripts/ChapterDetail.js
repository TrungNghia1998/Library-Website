    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result.data, function (key, item) {
                html += '<tr>';
                html += '<td>' + item.NameBook + '</td>';
                html += '<td>' + item.ChapterID + '</td>';
                html += '<td>' + item.Alias + '</td>';
                html += '<td>' + item.NameChapter + '</td>';
                html += '<td>' + item.Content + '</td>';
                html += '<td><a class="btn btn-default btn-sm" href="/Admin/ChapterDetail/Edit?idbook=' + item.IDBook + '&idchapter=' + item.ChapterID + '"><i class="fa fa-edit"></i> Sửa</a>  <a class="btn btn-danger btn-sm" onclick="Delete(' + item.IDBook + ',' + item.ChapterID + ')"><i class="fa fa-trash"></i> Xoá</a></td>';
                html += '</tr>';
            });
            $('.tbody').html(html);
